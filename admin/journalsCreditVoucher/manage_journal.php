...
$qry_year = $conn->query("SELECT max(voucher_number) as vn FROM `journal_entries` where year_id = '$val' and journal_type = 'cv'");
    ...
    <form action="" id="journal-form">
        ...
        <div class="row">
			...
			<div class="col-md-4 form-group">
				...
				<input type="hidden" name="journal_type" value="cv">
				<input type="hidden" name="new" id="new" value="0">
				<input type="hidden" name="debit_count" id="debit_count" value="0">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                Account-Economic Code (Cr)<select id="account_id" class="from-control form-control-sm select2" data-width="auto">
            ...
            <div class="form-group col-md-2">
                Bank/Cash (Dr)<select id="gr_id" class="from-control form-control-sm form-control-border select2">
                    <option value="" disabled selected></option>
                    <?php 
