...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<button class="btn btn-primary btn-flat btn-sm" id="create_new" type="button"><i class="fa fa-pen-square"></i> Credit Voucher Entry</button>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-hover table-striped table-bordered">
					...
					<tr>
						...
						<th class="p-0" style="background: #faefe3;">
							<div class="d-flex w-100">
								<div class="col-8 border">Description</div>
								<div class="col-2 border" style="text-align: right;">Debit</div>
								<div class="col-2 border" style="text-align: right;">Credit</div>
							</div>
						</th>
				<!--		<th>Encoded By</th>   -->
				...
				<tbody>
					...
					if($_settings->userdata('type') == 1){
						$swhere = " where user_id = '{$_settings->userdata('id')}' and year_id = '{$_settings->userdata('year_id')}' and journal_type='cv' ";
					}
					...
					<tr>
						...
						<td class="p-0">
							...
							<div class="d-flex w-100">
							   <?php if ($rowss['type'] == 1 )	{ ?>
									<div class="col-8 border"><?= $rowss['account'] ?></span></div> <?php } ?>
								<?php if ($rowss['type'] == 2 )	{ ?>
									<div class="col-8 border"><span class="pl-4"><?= $rowss['account'] ?></span></div> <?php } ?>
