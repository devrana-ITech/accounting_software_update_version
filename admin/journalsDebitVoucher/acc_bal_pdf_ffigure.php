...
if ($journals->num_rows > 0){
	while($row = $journals->fetch_assoc()){
	   ...
	   if ($row['all_total'] != 0) {
			...
			if ($row['gov_amount'] != 0){
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row['gov_amount'], 2).'</td>';
			...
			if ($row['aid_amount'] != 0){
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row['aid_amount'], 2).'</td>';
			...
			$data .= '<td class="cl3" style="padding: 3px;">'.number_format($row['all_total'], 2).'</td>';
			...
			while($row_gov_exp = $journals_gov_exp->fetch_assoc()){
				...
				if ($row_gov_exp['Crt'] != 0) {
					$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row_gov_exp['Crt'], 2).'</td>';
			...
			while($row_aid_exp = $journals_aid_exp->fetch_assoc()){
				...
				if ($row_aid_exp['Crt'] != 0) {
					$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row_aid_exp['Crt'], 2).'</td>';					
		...
		if (($r_gov_exp + $r_aid_exp) != 0){
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format(($r_gov_exp + $r_aid_exp), 2).'</td>';
			}else{
				$data .= '<td class="cl2" style="padding: 3px;">--</td>';
			}
			if (($r_gov_total-$r_gov_exp) == 0){
				...
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format(($r_gov_total-$r_gov_exp), 2).'</td>';
				$bal_gov_total = $bal_gov_total + $r_gov_total-$r_gov_exp;
			}
			if (($r_aid_total-$r_aid_exp) == 0){
				$data .= '<td class="cl2" style="padding: 3px;">--</td>';
			}else{
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format(($r_aid_total-$r_aid_exp), 2).'</td>';
				$bal_aid_total = $bal_aid_total + $r_aid_total-$r_aid_exp;
			}
			if ((($r_aid_total + $r_gov_total) - ($r_gov_exp + $r_aid_exp)) != 0){
				$data .= '<td class="cl2" style="padding: 3px;">'.number_format((($r_aid_total + $r_gov_total) - ($r_gov_exp + $r_aid_exp)), 2).'</td></tr>';
			}else {
...
$data .= '<tr><td style="padding: 3px;" colspan="2"><b>Total Recurrent Expenditure</b></td><td class="cl2">'.number_format($gov_total, 2).'</td><td class="cl2">'.number_format($aid_total, 2).'</td><td class="cl3">'.number_format(($gov_total + $aid_total), 2).'</td><td class="cl2">'.number_format($gov_exp_total, 2).'</td><td class="cl2">'.number_format($aid_exp_total, 2).'</td><td class="cl2">'.number_format($total_exp, 2).'</td><td class="cl2">'.number_format($bal_gov_total, 2).'</td><td class="cl2">'.number_format($bal_aid_total, 2).'</td><td class="cl2">'.number_format(($bal_aid_total + $bal_gov_total), 2).'</td></tr>';
...
if ($gov_total == 0){
	...
	$data .= '<td class="cl2">'.number_format($gov_total, 2).'</td>';
}

if ($aid_total == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($aid_total, 2).'</td>';
}

if (($gov_total + $aid_total) == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl3">'.number_format(($gov_total + $aid_total), 2).'</td>';
}
if ($gov_exp_total == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($gov_exp_total, 2).'</td>';
}
if ($aid_exp_total == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($aid_exp_total, 2).'</td>';
}

if ($total_exp == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($total_exp, 2).'</td>';
}

if ($bal_gov_total == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($bal_gov_total, 2).'</td>';
}

if ($bal_aid_total == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format($bal_aid_total, 2).'</td>';
}

if (($bal_aid_total + $bal_gov_total) == 0){
	$data .= '<td class="cl2">--</td>';
}else{
	$data .= '<td class="cl2">'.number_format(($bal_aid_total + $bal_gov_total), 2).'</td></tr>';
}
...
$data .= '<tr><td style="padding: 3px;" colspan="2"><b>Total Expenditure (A + B)</b></td><td class="cl2">'.number_format($grand_gov_total, 2).'</td><td class="cl2">'.number_format($grand_aid_total, 2).'</td><td class="cl3">'.number_format($grand_alloc_total, 2).'</td><td class="cl2">'.number_format($grand_gov_exp_total, 2).'</td><td class="cl2">'.number_format($grand_aid_exp_total, 2).'</td><td class="cl2">'.number_format($grand_exp_total, 2).'</td><td class="cl2">'.number_format($grand_bal_gov, 2).'</td><td class="cl2">'.number_format($grand_bal_aid, 2).'</td><td class="cl2">'.number_format($grand_bal, 2).'</td></tr>';
