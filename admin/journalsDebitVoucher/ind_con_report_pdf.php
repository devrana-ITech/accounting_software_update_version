...
while($t_row_d = $t_row->fetch_assoc()){
	$title .= 'Consultant\'s Name: <b>'.$t_row_d['payee_name'].'</b>  -::-  Designation: <b>'.$t_row_d['designation'].'</b>  -::-  Contract Date: <b>'.date("d-m-Y", strtotime($t_row_d['contract_date'])).'</b>';
}
...
//ind_con_report_pdf.php  p.designation, contract_date
