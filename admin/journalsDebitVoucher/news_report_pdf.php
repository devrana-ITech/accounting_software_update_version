...
while($row_d = $details->fetch_assoc()){
	...
	.'<td style="text-align: left; width: 70%; font-size: 12px;">'.$row_d['payee_name'].'</td>'
	.'<td style="text-align: right; width: 20%; font-size: 12px;">'.format_num($row_d['grossamt']).'</td></tr>';
	
}
$data .= '<tr><td style="text-align: left; font-size: 12px; width: 80%;" colspan="2"><b>Total</b></td>
...
<htmlpageheader name="letterheader">
		...
		<h3 style="margin-bottom: 2px;">Summary Payments -- Advertisement (Newspaper)</h3>
...
table, th, td {
  ...
  <table>
	...
	<tr>
	  ...
	  <th style="background-color: #f3e3fa; text-align: left; width: 70%; font-size: 12px;"><b>Newspaper Name</b></th>
