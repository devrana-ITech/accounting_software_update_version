...
<div class="container-fluid">
    <form action="" id="journal-form">
		...
		<div class="row">
			<div class="col-md-2 form-group">
                SC Deduction<input style="background-color: #f0dcf7;" type="number" id="sc_deduction" name="sc_deduction" class="form-control form-control-sm rounded-0" value="<?= isset($sc_deduction) ? $sc_deduction : "0" ?>" onkeyup="net_pay()" required>
            </div>
			...
			<div class="col-md-1 form-group">
                Commission<input style="background-color: #f0dcf7;" type="number" id="comm_deduction" name="comm_deduction" class="form-control form-control-sm rounded-0" value="<?= isset($comm_deduction) ? $comm_deduction : "0" ?>" onkeyup="net_pay()" required>
            </div>
...
updateDliType();
	...
	function net_pay(){
		...
		var comm_deduction = $('#comm_deduction').val();
		netpay.value = gross_amt - vat_deduction - it_deduction - sc_deduction - security_deduction - comm_deduction;
...
*/
    ...
    $(function(){
        ...
        $('#uni_modal #journal-form').submit(function(e){
			...
			var it_deduction = $('#it_deduction').val();
			var sc_deduction = $('#sc_deduction').val();
			if((vat_deduction+it_deduction+sc_deduction) == 0){
				urllocation = _base_url_+"classes/Master.php?f=save_journal";
			}else {
				urllocation = _base_url_+"classes/Master.php?f=save_journal_3";
			}
            $.ajax({
                url: urllocation,
				...
				error:err=>{
					console.log(err)
					alert_toast("An error occured (Sarkar).",'error');
					end_loader();
				},
