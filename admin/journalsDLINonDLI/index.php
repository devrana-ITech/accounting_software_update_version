...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Debit Voucher Adjustment Entries</h3>
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("New Debit Voucher Adjustment Entry","journalsDLINonDLI/manage_journal.php",'large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Debit Voucher Adjustment Entry","journalsDLINonDLI/manage_journal.php?id="+$(this).attr('data-id'),"large")
		})
		$('.duplicate_data').click(function(){
			uni_modal("Duplicate Debit Adjustment Voucher Entry","journalsDLINonDLI/manage_journal_dup.php?id="+$(this).attr('data-id'),"large")
		})
