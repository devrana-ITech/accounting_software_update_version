    ...
    <form action="" id="journal-form">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                Bank/Cash (Dr)<select id="account_id" class="from-control form-control-sm select2" data-width="auto">
                    <option value="" disabled selected></option>
                    <?php 
                    $accounts = $conn->query("SELECT * FROM `account_list` where id >= 51 and id <= 52 order by `name` asc ");
                    while($row = $accounts->fetch_assoc()):
            ...
            <div class="form-group col-md-3">
                Account-Economic Code (Cr)<select id="gr_id" class="from-control form-control-sm form-control-border select2">
                    <option value="" disabled selected></option>
                    <?php 
