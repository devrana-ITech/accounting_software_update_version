...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">GoB Voucher Entries</h3>
		<div class="card-tools">
			<button class="btn btn-primary btn-flat btn-sm" id="create_new" type="button"><i class="fa fa-pen-square"></i> GoB Voucher Entry</button>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<thead>
					<tr>
						...
						<th style="background: #faefe3; text-align: center;">Voucher No etc.</th>
				...
				<tbody>
					...
					if($_settings->userdata('type') == 1){
						$swhere = " where user_id = '{$_settings->userdata('id')}' and year_id = '{$_settings->userdata('year_id')}' and journal_type='gv' ";
					}
					...
					<tr>
						...
						<td class="text-center"><?= $row['voucher_number'] ?><br><?= $row['dli_type'] ?></td>
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("New GoB Journal Entry","govVoucher/manage_journal.php",'large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit GoB Journal Entry","govVoucher/manage_journal.php?id="+$(this).attr('data-id'),"large")
		})
		$('.duplicate_data').click(function(){
			uni_modal("Duplicate Journal Entry","govVoucher/manage_journal_dup.php?id="+$(this).attr('data-id'),"large")
		})
