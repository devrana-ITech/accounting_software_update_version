...
$qry_year = $conn->query("SELECT max(voucher_number) as vn FROM `journal_entries` where year_id = '$val' and journal_type = 'gv'");
    ...
    <form action="" id="journal-form">
        ...
        <div class="row">
            <div class="col-md-2 form-group">
				...
				<input type="hidden" name="journal_type" value="gv">
				...
				<input type="hidden" name="dli_type" id="dli_type" value="GoB">
				<input type="hidden" name="source_fund" id="source_fund" value="gob">
