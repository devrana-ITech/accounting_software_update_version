...
<div class="container-fluid">
    <form action="" id="account-form">
        ...
        <div class="form-group">
            <label for="description" class="control-label">Account Code</label>
			 <input type="text" name="acc_code" id="acc_code" class="form-control form-control-border" placeholder="Enter account Code" value ="<?php echo isset($acc_code) ? $acc_code : '' ?>" required>
        </div>
        <div class="form-group">
