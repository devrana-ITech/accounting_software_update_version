...
$journals = $conn->query("SELECT (case when sum(case when (account_id = 51) and journal_type = 'cv' and group_id = 1 then jt.amount end) is null then 0 else sum(case when (account_id = 51) and journal_type = 'cv' and group_id = 1 then jt.amount end) end) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join account_list al on al.id = jt.account_id WHERE year_id = 6 and (account_id = 51) and journal_type = 'cv' and dli_type = 'Non-DLI';");

$nondli_6 = 0;
if ($journals->num_rows > 0){
	while($row = $journals->fetch_assoc()){
	   if ($row['Crt'] != 0) {
			$nondli_6 = $nondli_6 + $row['Crt'];
	   }
	}
}


$nondli_total = $nondli_2 + $nondli_3 + $nondli_4 + $nondli_5 + $nondli_6;
...
$dli_total = $dli_2 + $dli_3 + $dli_4 + $dli_5 + $dli_6;
...
$nondli_dli6 = $nondli_6 + $dli_6;

$grand_total = $nondli_dli2 + $nondli_dli3 + $nondli_dli4 + $nondli_dli5 + $nondli_dli6;
        ...
        <table>
			...
			<tbody>
				<tr>
				  ...
				  <td class="cl2" style="background-color: #faf5fc;"><a href="advances.php?year_id=6&dli_type=Non-DLI" target="_blank"><b><?php if ($nondli_6 <= 0) echo  "--"; else echo number_format($nondli_6, 2); ?></b></a></td>
				...
				<tr>
				  ...
				  <td class="cl2" style="background-color: #f2ebf5;"><a href="advances.php?year_id=6&dli_type=DLI" target="_blank"><b><?php if ($dli_6 <= 0) echo  "--"; else echo number_format($dli_6, 2); ?></b></a></td>
				...
				<tr>
				  ...
				  <td class="cl2" style="background-color: #ffe6e6;"><a href="advances.php?year_id=6&dli_type=0" target="_blank"><b><?php if ($nondli_dli6 <= 0) echo  "--"; else echo number_format($nondli_dli6, 2); ?></b></a></td>
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 1 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 1 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 1 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 1 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 1 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 2 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 2 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 2 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 2 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 2 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 3 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 3 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 3 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 3 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 3 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 4 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 4 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 4 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 4 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 4 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 5 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 5 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 5 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 5 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 5 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 6 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 6 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 6 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 6 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 6 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 7 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 7 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 7 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 7 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 7 and dli_type = 'Non-DLI' group by eg.id;");
...
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 8 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 8 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 8 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 8 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 8 and dli_type = 'Non-DLI' group by eg.id;");
...
$item_1_total = $item_1_2 + $item_1_3 + $item_1_4 + $item_1_5 + $item_1_6;
$item_2_total = $item_2_2 + $item_2_3 + $item_2_4 + $item_2_5 + $item_2_6;
$item_3_total = $item_3_2 + $item_3_3 + $item_3_4 + $item_3_5 + $item_3_6;
$item_4_total = $item_4_2 + $item_4_3 + $item_4_4 + $item_4_5 + $item_4_6;
$item_5_total = $item_5_2 + $item_5_3 + $item_5_4 + $item_5_5 + $item_5_6;
$item_6_total = $item_6_2 + $item_6_3 + $item_6_4 + $item_6_5 + $item_6_6;
$item_7_total = $item_7_2 + $item_7_3 + $item_7_4 + $item_7_5 + $item_7_6;
$item_8_total = $item_8_2 + $item_8_3 + $item_8_4 + $item_8_5 + $item_8_6;
...
$col_4_total = $item_1_5 + $item_2_5 + $item_3_5 + $item_4_5 + $item_5_5 + $item_6_5 + $item_7_5 + $item_8_5;
$col_5_total = $item_1_6 + $item_2_6 + $item_3_6 + $item_4_6 + $item_5_6 + $item_6_6 + $item_7_6 + $item_8_6;

$col_6_total = $col_1_total + $col_2_total + $col_3_total + $col_4_total + $col_5_total;
        ...
        <table>
			<thead>
				<tr>
				  ...
				  <th class="cl4" style="background-color: #d48104; color: white;"><b>2025-26</b></th>
			...
			<tbody>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=1" target="_blank"><b><?php echo number_format($item_1_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=1" target="_blank"><b><?php echo number_format($item_1_6, 2) ?></b></td>	
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=1" target="_blank"><b><?php echo number_format($item_1_total, 2) ?></b></td>
				</tr>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=2" target="_blank"><b><?php echo number_format($item_2_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=2" target="_blank"><b><?php echo number_format($item_2_6, 2); ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=2" target="_blank"><b><?php echo number_format($item_2_total, 2) ?></b></td>
				</tr>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=3" target="_blank"><b><?php echo number_format($item_3_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=3" target="_blank"><b><?php echo number_format($item_3_6, 2) ?></b></td>	 
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=3" target="_blank"><b><?php echo number_format($item_3_total, 2) ?></b></td>
				</tr>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=4" target="_blank"><b><?php echo number_format($item_4_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=4" target="_blank"><b><?php echo number_format($item_4_6, 2) ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=4" target="_blank"><b><?php echo number_format($item_4_total, 2) ?></b></td>
				</tr>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=5" target="_blank"><b><?php echo number_format($item_5_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=5" target="_blank"><b><?php echo number_format($item_5_6, 2) ?></b></td>	
				  <td class="cl4" style="background-color: #faf5fc;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=5" target="_blank"><b><?php echo number_format($item_5_total, 2) ?></b></td>
				</tr>
				<tr>
				  ...
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=3&exp_group=6" target="_blank"><b><?php echo number_format($item_6_4, 2) ?></b></td>	  
				   <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=4&exp_group=6" target="_blank"><b><?php echo number_format($item_6_5, 2) ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=5&exp_group=6" target="_blank"><b><?php echo number_format($item_6_6, 2) ?></b></td>	  
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="nondli_group_report_pdf.php?year_id=6&exp_group=6" target="_blank"><b><?php echo number_format($item_6_total, 2) ?></b></td>
				</tr>
				<tr>
				  <td class="cl3" style="background-color: #f4f5f2;" colspan="7"><b>g) Grants under Part 3.2(b)</b></td>
				...
				<tr>
				  ...
				  <td class="cl4" style="background-color: #faf5fc;"><b><?php if ($item_7_5 <= 0) echo  "--"; else echo number_format($item_7_5, 2); ?></b></td>
				  <td class="cl4" style="background-color: #faf5fc;"><b><?php if ($item_7_6 <= 0) echo  "--"; else echo number_format($item_7_6, 2); ?></b></td>
				...
				<tr>
				  ...
				  <td class="cl4" style="background-color: #f2ebf5;"><b><?php if ($item_8_5 <= 0) echo  "--"; else echo number_format($item_8_5, 2); ?></b></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><b><?php if ($item_8_6 <= 0) echo  "--"; else echo number_format($item_8_6, 2); ?></b></td>	
				...
				<tr>
				  ...
				  <td class="cl4" style="background-color: #ffe6e6;"><a href="nondli_report_pdf.php?year_id=5" target="_blank"><b><?php echo number_format($col_2_total, 2) ?></b></a></td>
				  <td class="cl4" style="background-color: #ffe6e6;"><a href="nondli_report_pdf.php?year_id=2" target="_blank"><b><?php echo number_format($col_3_total, 2) ?></b></a></td>
				  <td class="cl4" style="background-color: #ffe6e6;"><a href="nondli_report_pdf.php?year_id=3" target="_blank"><b><?php echo number_format($col_4_total, 2) ?></b></a></td>
				  <td class="cl4" style="background-color: #ffe6e6;"><a href="nondli_report_pdf.php?year_id=6" target="_blank"><b><?php echo number_format($col_5_total, 2) ?></b></a></td>
				  <td class="cl4" style="background-color: #ffe6e6;"><a href="nondli_report_pdf.php?year_id=4" target="_blank"><b><?php echo number_format($col_6_total, 2) ?></b></a></td>
				</tr>
			</tbody>
	   </table>
    </div>	
...
// for FY2025-26 
$journals = $conn->query("SELECT ((case when sum(case when eg.id = 2 and group_id = 1 and account_id <> 51 and account_id <> 52  then jt.amount end) is null then 0 else sum(case when eg.id = 2 and group_id = 1 and account_id <> 51 and account_id <> 52 then jt.amount end) end) - (case when sum(case when eg.id = 2 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) is null then 0 else sum(case when eg.id = 2 and group_id = 4 and account_id <> 51 and account_id <> 52 then jt.amount end) end)) as Crt from `journal_entries` je inner join `journal_items` jt on je.id = jt.journal_id inner join exp_group eg on eg.id = je.exp_group WHERE year_id = 6 and eg.id = 2 and dli_type = 'DLI' group by eg.id;");
...
$item_2_total_d = $item_2_2_d + $item_2_3_d + $item_2_4_d + $item_2_5_d + $item_2_6_d;
	...
	<p style="text-align: right; margin-bottom: 0px; font-size: 16px;"><i>(Amount in BDT)</i></p>
        <table>
			...
			<tbody>
				...
				<tr>
				  <td class="cl3" style="background-color: #f2ebf5;"><b>Works</b></td>
				  ...
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="dli_group_report_pdf.php?year_id=4&exp_group=2" target="_blank"><b><?php if ($item_2_5_d <= 0) echo  "--"; else echo number_format($item_2_5_d, 2); ?></b></a></td>
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="dli_group_report_pdf.php?year_id=5&exp_group=2" target="_blank"><b><?php if ($item_2_6_d <= 0) echo  "--"; else echo number_format($item_2_6_d, 2); ?></b></a></td>	
				  <td class="cl4" style="background-color: #f2ebf5;"><a href="dli_group_report_pdf.php?year_id=6&exp_group=2" target="_blank"><b><?php if ($item_2_total_d <= 0) echo  "--"; else echo number_format($item_2_total_d, 2); ?></b></a></td>
				</tr>
