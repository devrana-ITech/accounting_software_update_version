...
if(isset($_GET['id'])){
    $sql = $conn->query("SELECT * FROM `services` where id =" .$_GET['id']);
...
<div class="container-fluid">
    <form action="" id="services-form">
        ...
        <div class="row">
			...
			<div class="col-md-2 form-group">
                Invitation EOI<input style="background-color: #f0dcf7;" type="date" id="invitation_eoi" name="invitation_eoi" class="form-control form-control-sm rounded-0" value="<?=  isset($meta['invitation_eoi'])  ? $meta['invitation_eoi'] : "" ?>" required>
                </select>
            </div>
			<div class="col-md-2 form-group">
                Issue of REP<input style="background-color: #f0dcf7;" type="date" id="issue_rep" name="issue_rep" class="form-control form-control-sm rounded-0" value="<?=  isset($meta['issue_rep'])  ? $meta['issue_rep'] : "" ?>" required>
                </select>
            </div>
			<div class="col-md-2 form-group">
