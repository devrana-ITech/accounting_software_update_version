...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("New Procurement Goods Entry","Procurement/Goods/create_goods.php",'large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Procurement Goods Entry","Procurement/Goods/create_goods.php?id="+$(this).attr('data-id'),"large")
		})
