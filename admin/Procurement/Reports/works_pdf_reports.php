...
$details = $conn->query("SELECT * FROM `works` order by id ASC");
...
<htmlpageheader name="letterheader">
		...
		<h4 style="margin-top: -5px; margin-bottom: -1px;">Works Reports</h4>
...
table, th, td {
  ...
  <table>
	...
	<tr>
	  ...
	  <th rowspan="2" style="background-color: #f3e3fa; text-align: center;  font-size: 150px;"><b>Description of Package<br>as Per RDPP (Works)</b></th>
