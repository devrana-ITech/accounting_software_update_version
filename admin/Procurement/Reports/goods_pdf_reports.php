...
$details = $conn->query("SELECT * FROM goods order by id ASC");
...
// $data .= '<tr><td style="text-align: left; font-size: 150px; width: 78%;" colspan="4"><b>Total</b></td>
// <td style="text-align: right; font-size: 150px; width: 22%;"><b>'.format_num($net_amt).'</b></td></tr>';
...
<htmlpageheader name="letterheader">
		...
		<h4 style="margin-top: -5px; margin-bottom: -1px;">Goods Reports</h4>
...
table, th, td {
  ...
  <table>
	...
	<tr>
	  ...
	  <th rowspan="2" style="background-color: #f3e3fa; text-align: center;  font-size: 150px;"><b>Description of Package<br>as Per RDPP (Goods)</b></th>
