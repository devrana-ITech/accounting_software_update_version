...
if ($exp_group == 2)
	$title = "Works";
if ($exp_group == 3)
	$title = "Consultanting Services";
if ($exp_group == 4)
	$title = "Non-Consulting Services";
if ($exp_group == 5)
...
<htmlpageheader name="letterheader">
		...
		<h3 style="margin-bottom: 2px;">===WB Expenditure Details (DLI) -- '.$title.' ===</h3>
